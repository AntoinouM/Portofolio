        ...
        <section class="section bento">
            <div class="bento__container">
                <div class="bento__grid">
                    ...
                    <article class="bento__item bento__picture"></article>
                    <article class="bento__item bento__quote"></article>
